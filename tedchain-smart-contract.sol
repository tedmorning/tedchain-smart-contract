...
/**
 * Tedchain Network token smart contract.
 */
contract Tedchain is AbstractToken {
  /**
  ...
  /**
   * Create new Tedchain Network token smart contract, with given number of tokens issued
   ...
   */
  function Tedchain (uint256 _tokenCount) public {
    owner = msg.sender;
